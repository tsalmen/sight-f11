    ...
    <div class="wrap">
        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"><label for="bg_color"><?php _e('Custom background image:'); ?></label></th>
                    <td><input type="text" name="bg_image" id="bg_image" size="50" value="<?php echo get_option('bg_image'); ?>"/><br/><span
                            class="description"> <a href="<?php bloginfo("url"); ?>/wp-admin/media-new.php" target="_blank">Upload custom background image</a> using WordPress Media Library and insert its URL here </span><br/></td>
                </tr>
...
function options_update() {
	...
	update_option('bg_image', $_POST['bg_image']);
...
class GetConnected extends WP_Widget {
        ...
        ?>
            <?php echo $before_widget; ?>
                <?php if ( $title )
                    ...
                    <a href="<?php echo get_option('flickr_url'); ?>">Flickr</a>
                    ...
                    <!-- 500px -->
                    <?php if ( get_option('500px_url') ) : ?>
                    <div class="getconnected_500px">
                    <a href="<?php echo get_option('500px_url'); ?>">500px</a>
                    <span><?php echo get_option('500px_text'); ?></span>
                    </div>
                    <?php endif; ?>
                    <!-- /500px -->
    ...
    function form($instance) {
        ...
        ?>
            ...
            <div style="margin-bottom: 5px;">
                <a href="javascript: void(0);" class="social_title" style="font-size: 13px; display: block; margin-bottom: 5px;">500px</a>
                <p class="social_options">
                    <label for="500px_url">Profile url:</label>
                    <input type="text" name="500px_url" id="500px_url" class="widefat" value="<?php echo get_option('500px_url'); ?>"/>
